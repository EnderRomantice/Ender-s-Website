    ...
    >
      ...
      >
        ...
        >
         ...
         >
          <div
            className="flex items-center text-amber-50 text-3xl pointer-events-none z-9999"
            aria-label="Logo"
          >
            Ender's Website
          </div>
          ...
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto z-[9999] ${
          ...
          >
            ...
            >
              <span
                ref={textInnerRef}
                className="sm-toggle-textInner flex flex-col leading-none z-[100]"
              >
                {textLines.map((l, i) => (
                  <span
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2em; background: transparent; z-index: 9999; }
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: white; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y-auto; z-index: 9999; }
